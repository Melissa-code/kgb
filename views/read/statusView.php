...
<section class="row">
    <div class="col-12 d-flex justify-content-center">
        <!-- Add a status button -->
        <button class="btn btn-light font-weight-bold" type="button"><a href="<?= URL?>createStatus"><img src="<?= URL ?>/public/assets/images/icon-add.svg" alt="ajouter un statut" style="width: 1.5rem;"></a></button>
    </div>
</section>
