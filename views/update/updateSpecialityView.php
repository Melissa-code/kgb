...
<section class="container mb-5">
    <h1 class="text-light">Modifier la spécialité <?= $speciality->getName_speciality() ?></h1>
</section>
...
<section class="container my-5">
    <div class="row d-flex justify-content-center">
        <article class="col-10 col-md-7 col-lg-5 col-md-4 bg-dark bg-gradient bg-opacity-25 rounded-3 p-4">
