...
<section class="container my-5">
    <div class="row d-flex justify-content-center">
        <div class="col-10 col-lg-8 bg-dark bg-gradient bg-opacity-25 rounded-3 p-4" id="update-mission">
            <!-- form  --> 
                ...
                <div class="row"> 
                    ...
                    <div class="col-12">
                        ...
                        <!-- agents list link --> 
                            ...
                            <!-- Update id_agent --> 
                            <p class="form-label mt-3">Changer d'agents : </p>
                            <?php foreach($agents as $agent) :?>
                                <div class="form-check d-inline-block">
                    ...
                    <div class="col-12">
                        <div class="border border-secondary rounded-3 mb-3 p-4">
                            ...
                            <?php endforeach; ?>
                            <!-- update code_contact -->
                            <p class="form-label mt-3">Changer de contacts : </p>
                            <?php foreach($contacts as $contact) :?>
                                <div class="form-check d-inline-block" >
                    ...
                    <div class="col-12">
                        <div class="border border-secondary rounded-3 mb-3 p-4">
                            ...
                            <?php endforeach; ?>
                            <!-- Change code_target --> 
                            <p class="form-label mt-3">Changer de cibles : </p>
                            <?php foreach($targets as $target) :?>
                                <div class="form-check d-inline-block" >
                    ...
                    <div class="col-12">
                        <div class="border border-secondary rounded-3 mb-3 p-4">
                            ...
                            <?php endforeach; ?>
                            <!-- Change id_hideout --> 
                            <p class="form-label mt-3">Changer de planques : </p>
