        ...
        <div class="col-12 d-flex justify-content-center" >
            <form action="<?= URL?>createMissionValidation" method="POST" >
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control mx-2" id="country_mission" name="country_mission">
                </div>
                <!-- id_agent --> 
                <div class="btn-group d-block mb-3" role="group" aria-label="Basic checkbox toggle button group">
                    <label class="form-label me-3">Agent(s) : </label>
                        ...
                        <label class="btn btn-outline-secondary" for="id_agent" value="<?= $agent->getId_agent(); ?>"><?= $agent->getName_agent()." ".$agent->getFirstname_agent(); ?></label>
                ...
                <div class="btn-group d-block mb-3" role="group" aria-label="Basic checkbox toggle button group">
                    ...
                    <label class="btn btn-outline-secondary" for="code_contact" value="<?= $contact->getCode_contact(); ?>"><?= $contact->getName_contact()." ".$contact->getFirstname_contact(); ?></label>
                ...
                <div class="btn-group d-block mb-3" role="group" aria-label="Basic checkbox toggle button group">
                    ...
                    <label class="btn btn-outline-secondary" for="code_cible" value="<?= $target->getCode_target(); ?>"><?= $target->getName_target()." ".$target->getFirstname_target(); ?></label>
