...
class Mission {
    ...
    private string $oldcode_mission;
    ...
    public function getOldcode_mission() { return $this->oldcode_mission; }
    public function setOldcode_mission($oldcode_mission){$this->oldcode_mission = $oldcode_mission;return $this; }
